...
$templates = array();
$templates["map_simple_512.map"] = "S-Labirynth 512";
$templates["map_complex_512.map"] = "C-Labyrinth 512";
$templates["baldurs.map"] = "Baldurs Gate";
$templates["dragon_age.map"] = "Dragon Age";
foreach ($templates as $mapTemplate => $mapTitle)
{
	...
	// Add action
	$attr = array();
	$attr['map_name'] = $mapTemplate;
	$actionFactory->setAction($templateTile, "loadMap", "", $attr, $loading = TRUE);
